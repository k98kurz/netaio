...
- Acceptance Criteria:
    - NetworkNodeProtocol.extract_keys property in common.py (line 239) type changed from `Callable[[MessageProtocol], list[Hashable]]` to `Callable[[MessageProtocol, tuple[str, int] | None], list[Hashable]]`
