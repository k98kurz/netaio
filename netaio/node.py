...
class UDPNode:
    ...
    def __init__(
        ...
        """Initialize the UDPNode.
            ...
            i.e. when a message auth check fails. If it returns a
            message, that message will be sent as a response to the
            sender of the message that failed the auth check. The
